...
public class BounceObject : MonoBehaviour {
	...
	public float MoveRange = 0.3f; //change this to increase/decrease the distance between the highest and lowest points of the bounce
	public float MoveSpeed = 0.1f; //change this to make it faster or slower
